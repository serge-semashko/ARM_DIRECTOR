...
ACol := pntlproj.Rows[ARow].Add(0, offset1);
...
ACol := pntlproj.Rows[ARow].Add(offset2, 300);
...
ACol := pntlclips.Rows[ARow].Add(0, offset1);
...
ACol := pntlclips.Rows[ARow].Add(offset2, 300);
...
ACol := pntlprep.Rows[ARow].Add(0, offset0);
...
ACol := pntlprep.Rows[ARow].Add(offset0, offset1-offset0);
...
ACol := pntlprep.Rows[ARow].Add(offset2, 300);
...
ACol := pntlprep.Rows[ARow].Add(0, offset1);
...
ACol := pntlplist.Rows[ARow].Add(0, offset1);
...
ACol := pntlplist.Rows[ARow].Add(offset2, 300);
...
ACol := pntlapls.Rows[ARow].Add(0, offset1);
...
ACol := pntlapls.Rows[ARow].Add(offset2, 300);
