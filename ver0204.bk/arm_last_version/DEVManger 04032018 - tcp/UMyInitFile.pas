...
uses MainUnit, ucommon, ShellApi, shlobj, registry, uwebget;
...
begin
    ...
    //jsonware_url := ini.ReadString('MAIN', 'URLServer', jsonware_url);
...
begin
    ...
    //ini.WriteString('MAIN', 'URLServer', jsonware_url);
