...
function SetTypeScreen0() {
  ...
  HeightMenu = $("#rowcanvasmenu").innerHeight();
  scrH = scrH - HeightMenu;
  ...
  var prevents = 1 - prdevices - prtl - pralltl;// - prcellar;
...
//?????????????????????????      
  ...
  DeviceCanvasTop = +HeightMenu + +evCanvas.height; 
  TimelineCanvasTop = +HeightMenu + +evCanvas.height + +dvCanvas.height; 
...
function SetTypeScreen1() {
  ...
  HeightMenu = $("#rowcanvasmenu").innerHeight();//scrH / 100 * 5;
  scrH = scrH - HeightMenu;
...
//==============================================================================  
  ...
  var prevents = 1 - prtl - pralltl - prdevices;
  ...
  var dlt = 1 - prtl - pralltl - prdevices  - prev1 - prev2 -preva;
  if (dlt > 0) {
    if (cnt1 > 0) {
      dlt = dlt / cnt1;
...
//==============================================================================
  ...
  if (ScreenFields[0] !== -1) {
    if (ScreenFields[0] == 0) {
      ...
      DeviceCanvasTop = +HeightMenu;// mnCanvas.height;
    } else if (ScreenFields[0] == 2) {
      evCanvas.width = scrW;
      evCanvas.height = scrH * prtl;  
      TimelineCanvasTop = +HeightMenu;// mnCanvas.height;
  ...
  if (ScreenFields[1] !== -1) {
    if (ScreenFields[1] == 0) {
      ...
      TimelineCanvasTop = +HeightMenu + +evCanvas.height;
  ...
  if (ScreenFields[2] !== -1) {
    if (ScreenFields[2] == 0) {
      ...
      DeviceCanvasTop = +HeightMenu + +evCanvas.height + +dvCanvas.height;
...
function screenNotEvents() {
  ...
  tmCanvas.style.visibility = "hidden";
    ...
    HeightMenu = $("#rowcanvasmenu").height();//(scrH / 100) * MenuProcent;
    //var prmenu = HeightMenu / scrH;
    
    //mnCanvas.width = scrW;
    //mnCanvas.height = scrH * prmenu;
    evCanvas.width = scrW;
    evCanvas.height = scrH - HeightMenu;//mnCanvas.height;//* 0.90;
    dvCanvas.width = scrW;
    dvCanvas.height = 0;//scrH * 0.02;
    edCanvas.width = scrW;
    edCanvas.height = 0;//scrH * 0.02;
