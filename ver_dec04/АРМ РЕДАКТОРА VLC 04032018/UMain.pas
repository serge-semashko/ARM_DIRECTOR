...
begin
  try
    ...
    if Form1.MySynhro.Checked and (not MyTimer.Enable) and Form1.cbxYesSynch.Checked then
    begin
    ...
    // application.ProcessMessages;
    if Form1.MySynhro.Checked and MyTimer.Enable and Form1.cbxYesSynch.Checked  then
    begin
      ...
      begin
        ...
        begin
          ...
          begin
            TLParameters.Position := TLParameters.Start + ftm - MyStartPlay;
                  PutJsonStrToServer('TLP',TLParameters.SaveToJSONStr);
            if TLParameters.vlcmode = Paused then MediaPlay;
...
begin
  Try
    ...
    Form1.Caption := ProgrammName;
    Form1.Label26.Caption := ProgrammFullName;
...
begin
  try
    ...
    if TLParameters.vlcmode <> play then TLZone.DrawBitmap(bmptimeline);
    ...
    //begin
      ...
      begin
        ...
        if TLParameters.vlcmode <> play then MyPanelAir.AirEvents.Init(Form1.imgEvents.Canvas);
        MyPanelAir.SetValues;
...
begin
  try
    ...
    // ssssjson
    LoadProject(false,1);
    //      PutGridTimeLinesToServer(Form1.GridTimeLines,1);
...
begin
  ...
  if (TLParameters.vlcmode = play) and (res<>10) then begin
    frLock.ShowModal;
    exit;
  end;
...
begin
  //MySynhroClick(nil);
  MySynhro.Checked := CheckBox3.Checked;
end;
...
begin
  ...
  begin
    ...
    begin
      ...
      MySynhro.Checked := FALSE;
      SetButtonsPredNext;
      CheckBox3.Checked := MySynhro.Checked;
      exit;
    end;
