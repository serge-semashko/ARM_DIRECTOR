...
begin
  if trim(server_addr)='' then server_addr:='0.0.0.0';
  ...
  if trim(Edit1.Text)='' then begin
    Label2.Caption:='Не задан условный номер модуля.'#13#10;
    ...
    if Edit2.Visible then begin
      Label2.Caption:=Label2.Caption + 'Управляющий сервер не обнаружен.' + #13#10
                              + 'Проверьте запущен ли он или укажите правильный'
                              + #13#10 + 'IP Адрес и IP Порт.';
    end;
    Disconnect_redis;
  end;
