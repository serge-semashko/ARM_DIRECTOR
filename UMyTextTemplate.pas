...
procedure LoadTextTemplateFromFile(FileName : string);
...
procedure SaveTextTemplateToFile(FileName : string);
var
  Stream: TFileStream;
...
begin
  ...
  begin
    LoadTextTemplateFromFile(pathtemp + '\TextTemplates.lst');
    SelectListsName;
...
begin
  ...
  begin
    ...
    if ModalResult = mrOk then
      SaveTextTemplateToFile(pathtemp + '\TextTemplates.lst');
      SaveTextTemplateToFile(pathproject + '\TextTemplates.lst');
  end;
end;
