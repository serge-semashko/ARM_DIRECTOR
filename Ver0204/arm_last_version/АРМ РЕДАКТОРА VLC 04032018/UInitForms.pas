...
uses UMain, UCommon, UImgButtons, UDrawTimelines, UTimeline, UProject, UGrid,
  ...
  uimagetemplate, uairdraw, uimportfiles, umyfiles, usettemplate, useteventdata,
  ubuttonoptions, ugridsort, UMyMediaSwitcher, ushifttl, ushortnum, umyprint,
  upagesetup, umyltc, umytexttemplate, umynewlist, uplayer, umymenu,
  ufrsaveproject, ufrHotKeys, ufrlisterrors, umytexttable, umyoptions,
...
begin
  ...
  begin
    ...
    CheckBox3.Left := (Panel1.Width - form1.Canvas.TextWidth('Синхронизировать')
                      - 25) div 2;
    imgpldata.Repaint;
