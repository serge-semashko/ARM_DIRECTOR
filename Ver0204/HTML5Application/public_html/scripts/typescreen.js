...
function screenNotEvents() {
  ...
  tmCanvas.style.visibility = "hidden";
    ...
    mnCanvas.width = scrW;
    mnCanvas.height = scrH * 0.02;
    evCanvas.width = scrW;
    evCanvas.height = scrH * 0.90;
    dvCanvas.width = scrW;
    dvCanvas.height = scrH * 0.02;
    edCanvas.width = scrW;
    edCanvas.height = scrH * 0.02;
  ...
  edcv.clearRect(0, 0, edCanvas.width, edCanvas.height);
  tlcv.clearRect(0, 0, tvCanvas.width, tvCanvas.height);
  tmcv.clearRect(0, 0, tvCanvas.width, tvCanvas.height);
  mncv.fillStyle = "black";
  ecv.fillStyle = "black";
  dcv.fillStyle = "black";
  edcv.fillStyle = "black";
  tlcv.fillStyle = "black";
  ...
  edcv.fillRect(0, 0, edCanvas.width, edCanvas.height);
  tlcv.fillRect(0, 0, tvCanvas.width, tvCanvas.height);
  tmcv.fillRect(0, 0, tvCanvas.width, tvCanvas.height);
