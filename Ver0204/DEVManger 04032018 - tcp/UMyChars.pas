...
begin
    ...
    Memo1.Color := ProgrammEditColor;
    Memo1.Font.Name := ProgrammEditFontName;
    Memo1.Font.Size := ProgrammEditFontSize;
    Memo1.Font.Color := ProgrammEditFontColor;
...
var ps : integer;
begin
  ps := Memo1.Perform(em_LineFromChar, Memo1.SelStart, 0);
  Edit1.Text:=Memo1.Lines[ps];
end;
