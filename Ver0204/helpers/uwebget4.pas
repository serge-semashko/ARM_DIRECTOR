...
initialization
    ...
    fastvars.Add('TLP');
    fastvars.Add('CTC');
    fastvars.Add('DEVMAN[0]');
    fastvars.Add('DEVMAN[1]');
    fastvars.Add('DEVMAN[2]');
    fastvars.Add('DEVMAN[3]');
    fastvars.Add('DEVMAN[4]');
    fastvars.Add('DEVMAN[5]');
    fastvars.Add('DEVMAN[6]');
    fastvars.Add('DEVMAN[7]');
    fastvars.Add('DEVMAN[8]');
    fastvars.Add('DEVMAN[9]');
    fastvars.Add('DEVMAN[10]');
    fastvars.Add('DEVMAN[11]');
    fastvars.Add('DEVMAN[12]');
    fastvars.Add('DEVMAN[13]');
    fastvars.Add('DEVMAN[14]');
    fastvars.Add('DEVMAN[15]');
    EmptyWebVar.Name := '';
